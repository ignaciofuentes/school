authorization do
  ...
  role :timetable do
    ...
    has_permission_on [:schedules], :to => [:index, :edit, :destroy, :show, :new, :create, :update]
  ...
  # admin privileges
  role :admin do
    has_permission_on [:home],  :to => [:index, :hr, :timetable]
    has_permission_on [:users], :to=>[:edit, :profile, :index, :logout]
    has_permission_on [:weekday], :to => [:index, :week, :create]
  ...
  # student- privileges
  role :student do
    has_permission_on [:users], :to=>[:edit, :profile]
