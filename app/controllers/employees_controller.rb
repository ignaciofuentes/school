class EmployeesController < ApplicationController
  ...
  def index  
	    @employees = Employee.search(params[:query], params[:condition])	
  end
  ...
  def create 
    ...
    if @employee.save
      flash[:notice] = 'Created employee sucessfully.'
  ...
  session[:employee_step] = session[:employee_params] = nil 
	...
	@employee.current_step= session[:employee_step] ="personal_details"
